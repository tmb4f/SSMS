...
--CREATE PROCEDURE [Rptg].[uspSrc_Transfer_Request_Turn_Around_Time_OrgNames]

ALTER PROCEDURE [Rptg].[uspSrc_Transfer_Request_Turn_Around_Time_OrgNames]
       (
...
AS
/****************************************************************************************************************************************
WHAT: Create procedure Rptg.uspSrc_Transfer_Request_Turn_Around_Time_OrgNames
WHO : Tom Burgan
WHEN: 08/17/2021
WHY : Transfer request turn-around time: Request origin organizational groups
----------------------------------------------------------------------------------------------------------------------------------------
INFO:
      ...
      OUTPUTS:
                CLARITY_App_Dev.Rptg.uspSrc_Transfer_Request_Turn_Around_Time_OrgNames
----------------------------------------------------------------------------------------------------------------------------------------
...
GRANT EXECUTE, VIEW DEFINITION ON [Rptg].[uspSrc_Transfer_Request_Turn_Around_Time_OrgNames] to [HSCDOM\Decision Support]
GO

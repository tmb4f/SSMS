...
CREATE PROCEDURE [Rptg].[uspSrc_Transfer_Request_Turn_Around_Time_Units]
       (
...
GRANT EXECUTE, VIEW DEFINITION ON [Rptg].[uspSrc_Transfer_Request_Turn_Around_Time_Units] to [HSCDOM\Decision Support]
GO

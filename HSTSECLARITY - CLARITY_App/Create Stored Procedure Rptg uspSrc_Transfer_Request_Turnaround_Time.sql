...
CREATE PROCEDURE [Rptg].[uspSrc_Transfer_Request_Turnaround_Time]
       (
...
AS
/****************************************************************************************************************************************
WHAT: Create procedure Rptg.uspSrc_Transfer_Request_Turnaround_Time
WHO : Tom Burgan
WHEN: 08/20/2021
...
INFO:
      ...
      OUTPUTS:
                CLARITY_App.Rptg.uspSrc_Transfer_Request_Turnaround_Time
----------------------------------------------------------------------------------------------------------------------------------------

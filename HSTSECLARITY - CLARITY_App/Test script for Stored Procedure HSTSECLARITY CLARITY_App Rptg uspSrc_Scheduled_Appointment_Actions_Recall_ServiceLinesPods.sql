...
/*="SELECT DISTINCT 1 AS Sort, " & Parameters!DepartmentGrouperColumn.Value & " AS NAME FROM TabRptg.Dash_AmbOpt_ScheduledAppointmentMetric_Tiles WHERE " & Parameters!DepartmentGrouperColumn.Value & " IS NOT NULL UNION ALL SELECT 2, '" & Parameters!DepartmentGrouperNoValue.Value & "' ORDER BY 1,2;"*/

...
IF OBJECT_ID('tempdb..#mapid ') IS NOT NULL
DROP TABLE #mapid
/*
SELECT orgmap.organization_name
              ,svcmap.service_name
			  ,camap.clinical_area_name,
               ...
               ids.serviceline_division_name,
               ids.mc_operation_name,
               ids.post_acute_flag,
               ids.ambulatory_operation_name,
               ids.inpatient_adult_name,
               ids.childrens_name,
...
,mdms.serviceline_division_name
,mdms.mc_operation_name
,mdms.post_acute_flag
,mdms.ambulatory_operation_name
,mdms.inpatient_adult_name
,mdms.childrens_name
...
LEFT JOIN Rptg.vwRef_MDM_Supplemental mdms
ON mdms.EPIC_DEPARTMENT_ID = mdm.EPIC_DEPARTMENT_ID
...
WHERE 1=1
ORDER BY orgmap.organization_name
,svcmap.service_name
,camap.clinical_area_name
,ids.EPIC_DEPT_NAME
*/

--SELECT mdm.EPIC_DEPARTMENT_ID
-- ,mdm.EPIC_DEPT_NAME
--,mdm.EPIC_EXT_NAME
--,mdm.EPIC_DEPT_TYPE
--,mdm.EPIC_SPCLTY
...
--ON mdms.EPIC_DEPARTMENT_ID = mdm.EPIC_DEPARTMENT_ID
--WHERE 1=1
--AND mdms.serviceline_division_name IS NULL
--AND mdms.mc_operation_name IS NULL
--AND mdms.ambulatory_operation_name IS NULL
--AND mdms.inpatient_adult_name IS NULL
--AND mdms.childrens_name IS NULL
...
SELECT ids.organization_id,
       ...
       ids.EPIC_EXT_NAME,
	   ids.ambulatory_flag,
	   --ids.childrens_ambulatory_name,
	   --ids.mc_ambulatory_name,
	   --ids.ambulatory_operation_name,
	   --ids.childrens_name,
	   --ids.serviceline_division_name,
	   --ids.mc_operation_name,
